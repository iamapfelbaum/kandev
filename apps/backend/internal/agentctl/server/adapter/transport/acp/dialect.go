...
type acpDialect struct {
	...
	mcpToolCall          func(map[string]any, string, string, any) (mcpToolCallFrame, bool)
...
func (d acpDialect) parseMCPToolCall(
	meta map[string]any,
	kind string,
	title string,
	rawInput any,
	...
	return d.mcpToolCall(meta, kind, title, rawInput)
}
